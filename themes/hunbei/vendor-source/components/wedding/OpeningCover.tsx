...
>(function OpeningCover({ reduced, onFinish, onSkip, onPhaseChange }, ref) {
  ...
  return (
    <section
      ...
      data-chapter="overture"
      ref={element}
      data-phase={phase}
      data-side={phase === 'open' ? 'back' : 'front'}
      aria-busy={phase === 'opening'}
      aria-label="一线，同心。婚礼邀请封面"
    >
      <h1 className="sr-only">一线，同心。汪家喆与朱敏的婚礼邀请</h1>
      <div
      ...
      >
        <div className="cover-inside">
          <span>一封信的开始</span>
          <p data-redline-anchor="inside-title">
            <span data-rule="0">从此，</span>
            <br />
            <em data-rule="1">每一页都有你。</em>
          </p>
          <span
            className="cover-inside-names"
            data-redline-anchor="inside-names"
          >
            朱敏 & 汪家喆
          </span>
        </div>
